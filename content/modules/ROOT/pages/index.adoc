...
****
The TED Open Data Service allows machine-to-machine interaction with public procurement data. It enables open access to current and historical TED data through direct queries to our SPARQL endpoint.
